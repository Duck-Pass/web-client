				...
				<div className="py-12 md:py-20">
					...
					<div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-4 items-start md:max-w-2xl lg:max-w-none">
						...
						<div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
							<img
								className="w-32 h-32 p-1 -mt-1 mb-2 rounded-full"
								src={Duck1}
								alt=""
							/>
						...
						<div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
							...
							<div className="flex flex-row w-full justify-center items-center mt-2 space-x-2">
								<a
									href="https://github.com/AlexisMts"
									target="_blank"
									className="text-black hover:text-gray-400"
								>
									<Github />
						...
						<div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
							...
							<div className="flex flex-row w-full justify-center items-center mt-2 space-x-2">
								<a
									href="https://github.com/hugoducom"
									target="_blank"
									className="text-black hover:text-gray-400"
								>
									<Github />
								...
								<a
									href="https://www.linkedin.com/in/hugo-ducommun-9504241aa/"
									target="_blank"
									className="text-black hover:text-gray-400"
								>
									<Linkedin />
						...
						<div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
							...
							<div className="flex flex-row w-full justify-center items-center mt-2 space-x-2">
								...
								<a
									href="https://www.linkedin.com/in/rayane-annen/"
									target="_blank"
									className="text-black hover:text-gray-400"
								>
									<Linkedin />
